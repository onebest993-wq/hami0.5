 ...
 *
 * ── لماذا المقارنة صارمة بلا هامش: قياسٌ لا حدس ──────────────────────────────
 * جارتُها `guard-lawyer-inner-weight-ratchet` فيها هامش **٢ ك.ب**، فالسؤال مشروع:
 * أهذه هشّة؟ **قِيس، فلا.** ثلاثة أبنية متتالية من مصدرٍ لم يتغيّر فيه حرف:
 *     boot ٢٧٩ · Inner ١٥٧٢ · CommunityScreen ٢٥٣١ ك.ب — **متطابقة في الثلاثة**،
 *     وأعداد الحزم كذلك (١١ · ١٣٣ · ١٢٠).
 *
 * **والفرق عن عدّاد الحزم المجهرية مفهوم:** ذاك **عبورُ عتبة** — حزمةٌ تحوم عند ٥ ك.ب
 * تقفز بين الفئتين ببضعة بايتات (قيس تذبذبه ٣٨٩–٣٩٣ عبر ستّة أبنية). وهذا **مجموعٌ
 * مُقرَّب إلى الكيلوبايت**، فبضعة بايتات لا تحرّكه.
 *
 * **ومقيسٌ عبر المنصّات أيضاً:** خطُّ الأساس التُقط على ويندوز ومرّ على عدّاء لينكس
 * في أوّل تشغيلةٍ بلغته (الخطوة ٣٩ في `quality-gate.yml`) — فالأرقام محمولة.
 *
 * فإن سقطت يوماً بلا نموٍّ حقيقيّ، **فذلك دليلٌ جديد يُوجب هامشاً، ومقدارُه يُؤخذ من
 * ذلك السقوط** — لا من جارتها ولا من التخمين.
 */
