...
import { e2eViteBuildEnv, hamiBootScriptFingerprint, sourceFingerprint } from './e2e-build-env.mjs';
...
if (result.status === 0) {
    ...
    fs.writeFileSync(
        ...
        JSON.stringify({
            ...
            /* أيّ مصدرٍ يمثّله هذا الـdist — يفحصه globalSetup قبل كل تشغيلة E2E */
            ...sourceFingerprint(),
        }),
        'utf8',
    );
