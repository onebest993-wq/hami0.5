 ...
 *
 * ── تصحيحٌ في اليوم نفسه: ٣٩٢ ← ٤٠٠، لأنّ ٣٩٢ كان داخل نطاق الضجيج ─────────────
 * **العدد ليس حتمياً.** سُتّة أبنيةٍ من **مصدرٍ واحد لم يتغيّر فيه حرف** أعطت:
 *     ٣٨٩ · ٣٩١ · ٣٩١ · ٣٩٢ · ٣٩٣ · ٣٩٣        (وعددُ الحزم ثابتٌ ١٬٠٣٧ في كلّها)
 * فالتذبذب ±٢ حول ٣٩١، وسببُه حزمٌ تحوم عند حدّ الـ٥ ك.ب بالضبط فتعبره ذهاباً وإياباً:
 * البناء يحقن `__HAMI_BUILD_TIME__` وبصماتِ أسماء الملفّات، فتتغيّر البايتات قليلاً
 * في كلّ بناء.
 *
 * **وقد ضُبط أوّلاً على ٣٩٢ بقياسٍ واحد** — وهو رقمٌ **داخل** النطاق، أي بوّابةٌ تسقط
 * عشوائياً بلا انحدارٍ حقيقي. صُحّح إلى **٤٠٠**: فوق أعلى مُقاس (٣٩٣) بهامشٍ سبعة.
 *
 * **والهامش لا يُعمي:** الانحدار الحقيقيّ يُقاس بالعشرات لا بالآحاد — استيرادٌ ساكن
 * واحد أضاف **٧٠ حزمة** إلى إغلاق قسمٍ في تجربةٍ مقيسة اليوم. فسبعةٌ هامشاً تبتلع
 * الضجيج ولا تبتلع إشارة.
 *
 * **والدرس مكتوبٌ هنا لأنّه كلّف:** عتبةٌ تُقفَل بقياسٍ واحد قد تُقفَل داخل ضجيجها.
 * تُقاس ثلاثاً على الأقلّ قبل أن تصير بوّابة.
 */
const VIOLATION_BUDGET = 400;
