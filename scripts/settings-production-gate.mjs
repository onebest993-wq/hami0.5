...
const criticalPaths = [
    ...
    'src/app/components/lawyer/HamiSettings/HamiSettingsApp.tsx',
    'src/app/components/lawyer/HamiSettings/hooks/useSettingsActiveSection.ts',
    'src/app/services/settings/settingsSectionPersistence.ts',
...
const test = spawnSync(
    ...
    [
        ...
        'src/app/hooks/lawyerDashboard/settings/__tests__',
