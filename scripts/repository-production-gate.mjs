...
const test = spawnSync(
    ...
    [
        ...
        'src/app/components/lawyer/SmartRepository/hooks/__tests__/useRepositoryEscapeStack.test.ts',
        'src/app/components/lawyer/SmartRepository/hooks/__tests__/useRepositoryLifecycle.test.ts',
