...
const criticalPaths = [
    ...
    'src/app/hooks/lawyerDashboard/profile/profileShellCloseFlow.ts',
    'src/app/hooks/lawyerDashboard/profile/profileShellExit.ts',
    ...
    'src/app/services/profile/profileShellSnap.ts',
...
const test = spawnSync(
    ...
    [
        ...
        'src/app/hooks/lawyerDashboard/profile/__tests__/profileShellCloseFlow.test.ts',
        'src/app/hooks/lawyerDashboard/profile/__tests__/profileShellExit.test.ts',
        'src/app/hooks/lawyerDashboard/profile/__tests__/profileHostIdleRelease.test.ts',
        ...
        'src/app/hooks/lawyerDashboard/__tests__/lawyerDashboardHeaderVisibility.test.ts',
        ...
        'src/app/components/lawyer/dashboard/profile/__tests__/useProfileOpenFirstPageModel.test.ts',
