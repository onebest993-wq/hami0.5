...
describe('visitationScheduleEngine', () => {
    ...
    it('describes sleepover timing with separate pickup and return', () => {
        const lines = describeVisitationSessionTiming(
            {
                decisionMode: 'viewing_pickup_sleepover',
                location: 'بغداد',
                startTime: '10:00',
        ...
        expect(lines.some((l) => l.label.includes('مكان'))).toBe(true);
