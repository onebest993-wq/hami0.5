...
function buildKey(input) {
    ...
    return JSON.stringify({
        ...
        u: input.url,
        b: input.body,
        c: (_a = input.contentHash) !== null && _a !== void 0 ? _a : '',
    });
}
export function coalesceWifeSign(input, sign) {
    return __awaiter(this, void 0, void 0, function () {
        var key, pending, promise;
...
/** للاختبارات */
export function clearWifeSignInflightForTests() {
    inflight.clear();
}
