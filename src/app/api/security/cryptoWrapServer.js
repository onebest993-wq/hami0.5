...
export function deriveClientCryptoWrapCredential(accessToken) {
    return __awaiter(this, void 0, void 0, function () {
        var token, hash;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!token)
                        return [2 /*return*/, ''];
                    return [4 /*yield*/, sha256Bytes("".concat(token, ":hami-crypto-wrap-v1"))];
                case 1:
                    hash = _a.sent();
                    return [2 /*return*/, "bff:".concat(toBase64Url(hash))];
            }
        });
    });
}
