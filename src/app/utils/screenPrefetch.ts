...
export function prefetchLawyerDashboardLazyChunks(): void {
    ...
    runWhenIdle(() => {
        ...
        void import("@/app/components/lawyer/RoyalLawyerProfile/index");
    ...
    runWhenIdle(() => {
        ...
        void import("@/app/components/lawyer/GlobalSearchOverlay/index");
        void import('@/app/components/lawyer/ClientRequestsHub');
        void import('@/app/components/lawyer/ArchivePortal.tsx');
