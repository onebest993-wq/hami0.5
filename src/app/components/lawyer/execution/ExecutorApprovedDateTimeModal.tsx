                ...
                <div className="space-y-4">
                    <div>
                        ...
                        <input
                            ...
                            className="w-full backdrop-blur-sm bg-slate-800/30 border border-indigo-500/20 rounded-2xl p-3 text-white focus:outline-none focus:border-indigo-500/50 transition-all"
