...
import { Clock, MapPin, MessageCircle, Navigation, CheckCircle2, Trash2 } from 'lucide-react';
...
export const EventCard = React.memo(function EventCard({ event, index, onEdit, onDelete }: EventCardProps) {
    ...
    return (
        <motion.div
            ...
            className="relative bg-[#1A1E2E] rounded-xl border border-white/5 hover:border-indigo-500/30 transition-all overflow-hidden group"
        >
