...
export function AppearanceBlockPicker({ customize }: { customize: AppearanceBlockCustomize }) {
    ...
    return (
        <div>
            <p id={blockListId} className="text-[11px] font-bold text-white/80 mb-1.5">
            ...
            >
                <AppearancePressButton
                    ...
                    className={`min-h-[44px] min-w-[44px] px-2.5 py-1.5 rounded-xl text-[10px] font-bold border border-dashed touch-manipulation shrink-0 ${
                        customize.isAllSelected
                            ? 'border-[#E6C673]/70 bg-[#E6C673]/22 text-[#F7EBC4]'
                ...
                {customize.blocks.map((id) => {
                    ...
                    return (
                        <AppearancePressButton
                            ...
                            className={`min-h-[44px] min-w-[44px] px-2.5 py-1.5 rounded-xl text-[10px] font-bold border touch-manipulation ${
                                active
