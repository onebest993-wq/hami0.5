...
export type CriminalDashboardInstantFrameProps = {
    caseId: string;
    headline?: string;
    onClose?: () => void;
    onExitToHome?: () => void;
...
/**
 * هيكل الإضبارة الجزائية — نفس BootChrome. بلا واجهة تحميل نصية.
 */
export function CriminalDashboardInstantFrame({
    caseId,
    headline,
    onClose,
    onExitToHome,
}: CriminalDashboardInstantFrameProps): React.ReactElement {
