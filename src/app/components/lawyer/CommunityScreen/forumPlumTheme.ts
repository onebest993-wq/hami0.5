 ...
 * كثافة مضغوطة: هوامش أقل، زوايا أخف، بلا نقش زخرفي.
 */
export const FORUM_PLUM_DEEP = '#0A0F1C';

const FORUM_PAGE_BG: React.CSSProperties = {
...
export const FORUM_FEED_CARD =
    'hami-forum-feed-card group relative rounded-xl p-3 ' +
    'transition-[border-color,background-color] duration-150 ease-out';

export const FORUM_FEED_CARD_READY = 'hami-forum-feed-card--ready';

export const FORUM_INTERACT_BTN =
    'flex items-center gap-1 rounded-lg px-2 py-2 min-h-[44px] touch-manipulation text-[#9AA3B2] ' +
...
export const FORUM_INTERACT_LABEL = 'text-[#9AA3B2] text-xs group-hover:text-[#F3F0EA] transition-colors duration-150';
export const FORUM_INTERACT_LABEL_ACTIVE = 'text-[#E6C673] font-bold text-xs';
...
export const FORUM_PUBLISH_FAB =
    'hami-forum-publish-fab ' +
    'pointer-events-auto touch-manipulation ' +
    'inline-flex w-auto max-w-max shrink-0 items-center gap-1.5 rounded-xl ' +
    'text-[#0A0F1C] px-3.5 py-2.5 min-h-[44px] font-bold transition-transform active:scale-[0.97]';

export const FORUM_PUBLISH_FAB_ICON =
    'relative z-[1] flex h-7 w-7 shrink-0 items-center justify-center rounded-md bg-[#0A0F1C]/10 text-[#0A0F1C]';

export const FORUM_PUBLISH_FAB_LABEL = 'relative z-[1] text-xs font-bold text-[#0A0F1C] tracking-wide';

export const FORUM_PUBLISH_FAB_DISABLED =
    'hami-forum-publish-fab pointer-events-none touch-manipulation opacity-45 ' +
    'inline-flex w-auto max-w-max shrink-0 items-center gap-1.5 rounded-xl hami-forum-ghost-btn text-[#9AA3B2] ' +
...
export const FORUM_PUBLISH_FAB_SLOT =
    ...
    'ps-[max(1rem,env(safe-area-inset-left))] pe-[max(1rem,env(safe-area-inset-right))] pb-[max(1rem,env(safe-area-inset-bottom))]';
...
/** شريط معلومات (عدد النتائج / الترتيب) */
export const FORUM_META_BAR =
    'hami-forum-glass-chip rounded-lg px-3 py-2 flex items-center gap-2 min-h-[36px]';

/** صف خيار في ورقة النشر */
export const FORUM_OPTION_ROW =
    'w-full min-h-[44px] touch-manipulation rounded-xl px-3 py-2.5 flex items-center gap-3 border transition-colors hami-forum-glass-chip';
...
export const FORUM_PANEL = 'hami-forum-panel rounded-xl';

export const FORUM_SHEET =
    'hami-forum-panel border-t border-white/[0.12] rounded-t-2xl hami-forum-app-bar';

export const FORUM_MODAL = 'hami-forum-modal-glass rounded-2xl';
...
export const FORUM_GHOST_BTN =
    'hami-forum-ghost-btn rounded-lg ' +
    'transition-[color,border-color,background-color] duration-150';

export const FORUM_COMMENT_CARD = 'hami-forum-panel rounded-xl p-3';
export const FORUM_COMMENT_BEST = 'hami-forum-panel rounded-xl p-3 border-[#E6C673]/35';
export const FORUM_STAT_BOX = 'hami-forum-panel rounded-lg p-2.5 text-center';
...
export const FORUM_DROPDOWN_PANEL =
    'hami-forum-panel rounded-xl overflow-hidden';
