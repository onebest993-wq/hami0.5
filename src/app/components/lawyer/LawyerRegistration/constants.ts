import { Castle, Anchor, Landmark, Crown, Waves, Palmtree, Flame, Sprout, Columns, Mountain, Tent, Hand, MapPin, Wheat, Gavel, Scale, Users, Building2, Briefcase, FileText, ShieldAlert, Navigation, Home, Car, User, FileBadge } from 'lucide-react';
