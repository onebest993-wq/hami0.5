                ...
                <div className="flex items-center justify-between gap-2 mb-1">
                    <div className="flex items-center gap-2 min-w-0">
                        ...
                        <button
                            ...
                            className={`inline-flex shrink-0 items-center justify-center rounded-md border px-1.5 h-7 min-w-[2.75rem] text-[10px] font-bold leading-none transition-colors touch-manipulation ${
                                isClient
                                    ? side === 1
                                        ? 'border-emerald-400/50 bg-emerald-500/18 text-emerald-100'
                                        : 'border-rose-400/50 bg-rose-500/18 text-rose-100'
                                    : 'border-white/10 bg-transparent text-white/35 hover:border-white/18 hover:text-white/60'
                            }`}
                        >
                            موكل
                        </button>
