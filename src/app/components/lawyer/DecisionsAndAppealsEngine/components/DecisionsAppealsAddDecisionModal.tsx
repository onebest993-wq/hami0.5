                                    ...
                                    {showAddModal && (
                                        ...
                                        >
                                            <motion.div
                                                ...
                                                className="my-auto flex max-h-[80vh] w-full max-w-2xl flex-col overflow-hidden rounded-2xl border border-white/15 bg-slate-900/50 shadow-lg backdrop-blur-sm"
