/**
 * مهام الميدان — سطح خفيف مضغوط
 * Navy #0A0F1C · ذهب #E6C673 · زمرد للنجاح · لمس ≥ 44px
 */
export const TASKS_CHROME = '#0A0F1C';

/** إخفاء شريط التمرير مع الإبقاء على التمرير */
const TASKS_SCROLL_CHROME =
    '[-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden';

/** سطح داخلي للبطاقات */
export const TASKS_INNER_GLASS = 'border-[#E6C673]/10 bg-white/[0.02]';

export const TASKS_INNER_GLASS_SOFT = 'bg-white/[0.02]';

export const TASKS_INNER_GLASS_HOVER = 'hover:bg-white/[0.04]';
...
export const TASKS_DAY_PANEL =
    'relative mb-2 min-w-0 overflow-x-hidden p-2.5 rounded-xl border border-white/[0.06] bg-white/[0.02]';

export const TASKS_INPUT =
    'w-full rounded-xl border border-white/[0.1] bg-[#12182B] px-3 py-2 text-base text-[#F4F4F5] min-h-[44px] ' +
...
export const TASKS_DIALOG_CONTENT =
    'border-white/[0.08] bg-[#0A0F1C] text-[#F4F4F5] sm:max-w-md rounded-xl';

export const TASKS_DIALOG_CONTENT_WIDE =
    'border-white/[0.08] bg-[#0A0F1C] ' +
    `text-[#F4F4F5] sm:max-w-lg max-h-[90dvh] overflow-y-auto rounded-xl ${TASKS_SCROLL_CHROME}`;
...
export const TASKS_DIALOG_SUBPANEL =
    'rounded-xl border border-white/[0.07] bg-white/[0.02] p-2 space-y-2';
...
export const TASKS_BTN_PRIMARY =
    'text-xs font-semibold px-3 py-2 min-h-[44px] rounded-xl border border-[#34D399]/30 bg-[#34D399]/10 text-[#A7F3D0] ' +
    'hover:bg-[#34D399]/16 transition touch-manipulation';

export const TASKS_BTN_BRONZE =
    'hami-tasks-btn-bronze text-xs font-semibold px-3 py-2 min-h-[44px] rounded-xl border border-[#E6C673]/22 bg-transparent text-[#E6C673] ' +
...
export const TASKS_SECTION_TITLE = 'text-sm font-semibold text-[#F4F4F5] flex flex-row-reverse items-center gap-2';

export const TASKS_BRONZE_LINE = 'h-px bg-white/[0.08]';

/** ستارة الميدان السفلية — بلا ظل ثقيل */
export const CURTAIN_SHEET =
    ...
    'bg-[#0A0F1C] overflow-hidden';

export const CURTAIN_GLASS_INNER = TASKS_GLASS_PANEL;

export const CURTAIN_BACKDROP = 'fixed inset-0 z-[214] bg-[#05060D]/64 border-0 cursor-default';
...
export const TASK_CARD_BASE =
    'relative border rounded-xl flex flex-col overflow-hidden bg-white/[0.02]';

/** مكان البطاقة قبل اكتمال مقطع TaskCard — نفس ارتفاع البطاقة الحقيقية */
export const TASK_CARD_SLOT_CLASS =
    `${TASK_CARD_BASE} [content-visibility:auto] [contain-intrinsic-size:auto_7rem] border-white/[0.08]`;

export const TASK_CARD_DEFAULT = 'border-white/[0.08] hover:border-[#E6C673]/20';

export const TASK_CARD_DONE =
    'border-[#34D399]/24 bg-[#12182B]/90';
...
export const TASK_TOOL_BTN =
    'inline-flex flex-row-reverse items-center justify-center gap-1 rounded-xl px-2.5 ' +
    'min-h-[44px] min-w-[44px] text-[10px] font-extrabold border transition touch-manipulation';

export const TASK_CARD_ICON_BTN =
    'inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-xl border touch-manipulation';
...
/** بطاقة ستارة الميدان */
export const CURTAIN_TASK_TITLE = 'text-[#F4F4F5] text-[14px] font-semibold leading-snug break-words';
