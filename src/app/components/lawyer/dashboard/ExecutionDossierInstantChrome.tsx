...
import { ExecutionDossierHeaderNavButtons } from '@/app/components/lawyer/ExecutionDashboard/components/ExecutionDossierHeaderNavButtons';
...
/**
 * قشرة فورية لإضبارة التنفيذ على MainView — بلا Portal/BootChrome
...
export function ExecutionDossierInstantChrome({
    ...
    return (
        <div
            className="fixed inset-0 z-[230] flex items-center justify-center bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 backdrop-blur-3xl p-0"
            dir="rtl"
            ...
            <div className="flex h-full w-full max-w-md flex-col border border-slate-700/30 bg-slate-900/95 shadow-2xl">
                <div className="mx-2 mt-2 rounded-xl border-b border-black/50 border-t border-white/10 bg-gradient-to-r from-slate-800/40 via-slate-700/20 to-slate-800/40 shadow-[0_8px_32px_0_rgba(0,0,0,0.3)] backdrop-blur-xl">
                    <div className="flex w-full items-center gap-2 px-3 py-2.5">
                        <ExecutionDossierHeaderNavButtons onExit={onExitToHome} showBack={false} />
