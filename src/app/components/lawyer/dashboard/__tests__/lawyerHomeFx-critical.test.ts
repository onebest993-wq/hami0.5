...
describe('lawyerHomeFx-critical', () => {
    ...
    it('يتضمن قواعد rim/accent اللازمة لأول رسم بلا FOUC', () => {
        ...
        expect(css).toContain('#hami-field-tasks-instant-chrome');
        ...
        expect(css).toContain("html:not([data-hami-repository-open='1']):not([data-hami-repository-closing='1']) .hami-repository-overlay-layer:not(.hami-repository-overlay-layer--visible)");
        expect(css).toContain('#hami-repository-instant-chrome');
