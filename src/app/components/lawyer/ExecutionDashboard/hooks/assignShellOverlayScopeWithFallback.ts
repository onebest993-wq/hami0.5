...
export function assignShellOverlayScopeWithFallback(
...
/** Thin wrapper — assigns into a fresh object. */
export function withShellOverlayScopeFallback(
    scope: Record<string, unknown>,
): Record<string, unknown> {
    return assignShellOverlayScopeWithFallback({}, scope);
}
