...
export const EXECUTION_ACTION_TILE_ICON_WRAP =
    'relative flex h-8 w-8 shrink-0 items-center justify-center rounded-xl border border-white/[0.1] bg-gradient-to-br from-white/[0.09] via-white/[0.02] to-transparent shadow-[inset_0_1px_0_rgba(255,255,255,0.12)]';
...
/** نغمات بلاطات الأدوات — هوية لونية أخف مع تمييز أيقونة أوضح. */
export const EXECUTION_ACTION_TILE_TONES = {
    appt: {
        ...
        iconWrapClass: 'border-violet-300/20 group-hover:border-violet-300/40 group-hover:bg-violet-500/[0.14]',
    ...
    notes: {
        ...
        iconWrapClass: 'border-orange-300/20 group-hover:border-orange-300/40 group-hover:bg-orange-500/[0.14]',
    ...
    documents: {
        ...
        iconWrapClass: 'border-sky-300/20 group-hover:border-sky-300/40 group-hover:bg-sky-500/[0.14]',
    ...
    decisions: {
        ...
        iconWrapClass: 'border-rose-300/22 group-hover:border-rose-300/42 group-hover:bg-rose-500/[0.14]',
    ...
    followup: {
        ...
        iconWrapClass: 'border-emerald-300/20 group-hover:border-emerald-300/40 group-hover:bg-emerald-500/[0.14]',
    ...
    finance: {
        ...
        iconWrapClass: 'border-amber-300/22 group-hover:border-amber-300/42 group-hover:bg-amber-500/[0.14]',
