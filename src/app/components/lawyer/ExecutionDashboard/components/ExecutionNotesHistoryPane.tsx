...
import { LazyDossierNotesVault as DossierNotesVault } from '../executionNotesInnerLazy';
...
export function ExecutionNotesHistoryPane(p: {
    pinnedNotes: unknown[];
    /** @deprecated Tasks UI removed from notes modal — callers pass []. */
    pinnedTasks?: unknown[];
    toggleCaseNotePin: (...args: never[]) => unknown;
    /** @deprecated Kept for API compat; ignored (no task pins). */
        ...
        >
            <div className="space-y-3">
                <ExecutionPinnedNotesTray
                    ...
                    onToggleTaskPin={(p.toggleCaseTaskPin ?? (() => undefined)) as never}
