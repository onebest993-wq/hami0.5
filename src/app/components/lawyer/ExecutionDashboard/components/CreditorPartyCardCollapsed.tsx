...
export function CreditorPartyCardCollapsed({
    ...
    return (
        <div className="flex w-full flex-col items-center justify-center gap-0.5" dir="rtl">
            <PartyCardCollapsedNameSlot actionsMenu={actionsMenu}>
                <div className="flex max-w-full min-w-0 flex-row flex-nowrap items-center justify-center gap-1 overflow-hidden">
                    {creditorHeirsWord ? (
                    ...
                    <span className="min-w-0 max-w-full truncate text-center text-base font-bold leading-none text-white sm:text-lg">
