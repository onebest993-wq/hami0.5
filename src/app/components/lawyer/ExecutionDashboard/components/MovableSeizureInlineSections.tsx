...
export type MovableSeizureInlineSectionsProps = {
    ...
    /** عند التحديد يُعرض قسم واحد فقط — داخل خطوة المسار */
    section?: MovableInlineSectionKey;
    /** داخل خطوة المسار — بدون حاوية منسدلة إضافية */
    embedded?: boolean;
    /** يربط نموذج الخبراء بقرار الخطوة الحالية (انتداب أول / لجنة بعد الاعتراض) */
                        ...
                        {requiredExperts <= 1 ? (
                            ...
                            <div className="space-y-2">
                                {expertNameSlots.map((slot, idx) => (
                                    ...
                                    >
                                        <label className="mb-1.5 block text-[9px] font-bold text-sky-200/90 text-right">
