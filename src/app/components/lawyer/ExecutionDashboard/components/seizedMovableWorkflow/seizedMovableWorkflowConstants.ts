export const MOVABLE_WORKFLOW_STEP_TITLES = [
    'تأييد وضع الإشارة',
...
export const MOVABLE_WORKFLOW_BTN =
...
export const MOVABLE_WORKFLOW_ACTION_SHELL = 'relative z-[2] space-y-2 pointer-events-auto';

export const MOVABLE_WORKFLOW_PATH_HINT = 'text-[10px] font-bold text-slate-500 text-right';
