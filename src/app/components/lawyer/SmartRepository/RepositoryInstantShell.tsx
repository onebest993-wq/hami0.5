            ...
            <div className={`${REPO_PANEL} flex flex-col`}>
                ...
                <div className="hami-repository-controls shrink-0 relative z-[1]">
                    <div className="px-5 pt-3 pb-1 flex items-center gap-2" dir="rtl" aria-hidden>
                        <div className="hami-repository-search-deck flex-1 min-w-0">
                            <div className="hami-repository-search-deck__row h-11 rounded-xl border border-white/10 bg-white/[0.04] opacity-70" />
                        </div>
                ...
                <span className="sr-only">جاري تجهيز المستودع</span>
            </div>
        </div>,
        document.body,
    );
