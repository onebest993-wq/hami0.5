...
export function buildSmartFileOrchestratorLayout(input: BuildSmartFileOrchestratorLayoutInput) {
    ...
    return assembleSmartFileModalLayout({
        ...
        handleArt172AppealStay: actions.handleArt172AppealStay,
        handleArt172AppealResume: actions.handleArt172AppealResume,
        handleJoinCoObjector: actions.handleJoinCoObjector,
