...
export const GLASS_CARD_BASE =
    'flex-1 rounded-xl bg-white/[0.03] border px-3 py-2 mr-8 transition-colors';
...
export const PAL = {
    gold: {
        ...
        icon: 'text-[#E6C673]',
        card: 'border-[#E6C673]/25 hover:border-[#E6C673]/45 ',
        dot: 'bg-[#E6C673]',
    ...
    orange: {
        ...
        card: 'border-orange-500/25 hover:border-orange-400/45 ',
        dot: 'bg-orange-400',
    ...
    amber: {
        ...
        icon: 'text-amber-300',
        card: 'border-amber-500/25 hover:border-amber-400/45 ',
        dot: 'bg-amber-400',
    ...
    red: {
        ...
        icon: 'text-red-300',
        card: 'border-red-500/25 hover:border-red-400/45 ',
        dot: 'bg-red-400',
    ...
    rose: {
        ...
        icon: 'text-rose-300',
        card: 'border-rose-500/25 hover:border-rose-400/45 ',
        dot: 'bg-rose-400',
    ...
    pink: {
        ...
        icon: 'text-pink-300',
        card: 'border-pink-500/25 hover:border-pink-400/45 ',
        dot: 'bg-pink-400',
    ...
    fuchsia: {
        ...
        card: 'border-fuchsia-500/25 hover:border-fuchsia-400/45 ',
        dot: 'bg-fuchsia-400',
    ...
    purple: {
        ...
        card: 'border-purple-500/25 hover:border-purple-400/45 ',
        dot: 'bg-purple-400',
    ...
    violet: {
        ...
        card: 'border-violet-500/25 hover:border-violet-400/45 ',
        dot: 'bg-violet-400',
    ...
    indigo: {
        ...
        card: 'border-indigo-500/25 hover:border-indigo-400/45 ',
        dot: 'bg-indigo-400',
    ...
    blue: {
        ...
        icon: 'text-blue-300',
        card: 'border-blue-500/25 hover:border-blue-400/45 ',
        dot: 'bg-blue-400',
    ...
    sky: {
        ...
        icon: 'text-sky-300',
        card: 'border-sky-500/25 hover:border-sky-400/45 ',
        dot: 'bg-sky-400',
    ...
    cyan: {
        ...
        icon: 'text-cyan-300',
        card: 'border-cyan-500/25 hover:border-cyan-400/45 ',
        dot: 'bg-cyan-400',
    ...
    teal: {
        ...
        icon: 'text-teal-300',
        card: 'border-teal-500/25 hover:border-teal-400/45 ',
        dot: 'bg-teal-400',
    ...
    emerald: {
        ...
        card: 'border-emerald-500/25 hover:border-emerald-400/45 ',
        dot: 'bg-emerald-400',
    ...
    lime: {
        ...
        icon: 'text-lime-300',
        card: 'border-lime-500/25 hover:border-lime-400/45 ',
        dot: 'bg-lime-400',
    ...
    yellow: {
        ...
        card: 'border-yellow-500/25 hover:border-yellow-400/45 ',
        dot: 'bg-yellow-400',
