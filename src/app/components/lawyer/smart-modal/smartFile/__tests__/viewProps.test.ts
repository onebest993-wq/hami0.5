...
function minimalInput(overrides: Partial<SmartFileLayoutBuildInput> = {}): SmartFileLayoutBuildInput {
    ...
    return {
        ...
        flags: {
            ...
            showAttorneyResignationModal: false,
            setShowAttorneyResignationModal: noop,
            showExecutionTransferModal: false,
            setShowExecutionTransferModal: noop,
            editingEvent: null,
