...
export function buildModalsPortalProps(input: SmartFileLayoutBuildInput): SmartFileModalsPortalProps {
    ...
    return {
        ...
        showAdjournPleadingModal: flags.showAdjournPleadingModal,
        setShowAdjournPleadingModal: flags.setShowAdjournPleadingModal,
        pendingJudgmentDate: flags.pendingJudgmentDate,
        setPendingJudgmentDate: flags.setPendingJudgmentDate,
