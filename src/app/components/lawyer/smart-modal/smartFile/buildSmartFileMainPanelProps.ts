...
export function buildMainPanelProps(input: SmartFileLayoutBuildInput): SmartFileMainPanelProps {
    ...
    return {
        ...
        handleArt172AppealStay: input.handleArt172AppealStay,
        handleArt172AppealResume: input.handleArt172AppealResume,
        handleJoinCoObjector: input.handleJoinCoObjector,
