...
import { Edit3, Shield } from '@/app/components/ui/lucideIcons';
                        ...
                        <div className="flex justify-between items-start mb-3">
                            ...
                            {onEdit && (
                                <button type="button"
                                    ...
                                    className="opacity-100 sm:opacity-0 sm:group-hover:opacity-100 sm:group-focus-within:opacity-100 p-2 rounded-lg hover:bg-red-500/20 text-red-400 transition-all min-h-[44px] min-w-[44px] flex items-center justify-center"
                                    title="تعديل"
                                >
                                    <Edit3 size={14} />
                                </button>
