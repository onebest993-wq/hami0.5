    ...
    return (
        <div className={`${INTERPLEADER_STRIP_SHELL} p-2.5`}>
            <div className="flex items-center gap-2 mb-2 min-w-0">
                <span className="flex items-center justify-center w-7 h-7 rounded-xl bg-[#E6C673]/14 border border-[#E6C673]/32 shadow-[0_0_16px_rgba(230,198,115,0.18)] shrink-0">
