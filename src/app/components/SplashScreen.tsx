...
const MainSplashLogoSrc = '/hami-logo-transparent.png';
    ...
    <div className="fixed inset-0 z-50 overflow-hidden font-['Tajawal'] select-none bg-[#05060D]" dir="rtl">
      ...
      <div className="absolute inset-0 z-10 flex flex-col px-6 pb-14 pt-12">
        ...
        <motion.div
          ...
          className="mx-auto mb-1 -mt-10 h-[60vh] max-h-[680px] min-h-[360px] w-[96vw] max-w-[1200px]"
        >
          <img
            src={MainSplashLogoSrc}
            alt="شعار حامي"
            className="h-full w-full object-contain object-center select-none pointer-events-none drop-shadow-[0_0_26px_rgba(230,198,115,0.30)]"
            loading="eager"
            decoding="async"
          />
        </motion.div>
