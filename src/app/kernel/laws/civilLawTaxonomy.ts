...
const CIVIL_PROCEDURE_TAXONOMY: CivilLawTaxonomy = {
...
const EVIDENCE_TAXONOMY: CivilLawTaxonomy = {
    codeType: 'evidence',
    sections: [
...
function articleMatchesTaxonomyBranch(
    articleNumber: string,
...
function articleMatchesTaxonomySection(
    articleNumber: string,
