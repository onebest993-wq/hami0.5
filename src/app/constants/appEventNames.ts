 ...
 *
 * تم نقله من app/runtime/eventConstants في T14 إلى مجلد constants محايد
 * ليتسنى استيراده من طبقة services دون عبور حد معماري محظور
 * (runtime ↚ services هي قاعدة T21 المعمارية).
 */
