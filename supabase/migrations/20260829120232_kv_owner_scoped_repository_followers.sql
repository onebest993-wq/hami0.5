-- مفاتيح KV الجديدة: repository:docs:<authorId>:<docId>
-- وفهرس المتابعين العكسي followers:<followingId>:<followerId>
-- المسح الذري يجب أن يحذف الشكل الجديد مع الإبقاء على تصفية authorId للمفاتيح القديمة.
