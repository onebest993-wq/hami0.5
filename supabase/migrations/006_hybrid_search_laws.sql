-- Hybrid Retrieval for Iraqi laws:
-- Combines vector similarity + full-text ranking using Reciprocal Rank Fusion (RRF)
...
COMMENT ON FUNCTION public.hybrid_search_laws(vector(768), text, integer, double precision)
  IS 'Hybrid search laws via vector similarity + FTS with RRF scoring';
