-- جدول نصوص القوانين العراقية مع متجهات للبحث الدلالي (Gemini → pgvector)
...
CREATE INDEX IF NOT EXISTS iraqi_laws_embedding_hnsw
  ON iraqi_laws
...
COMMENT ON TABLE iraqi_laws IS 'مواد تشريعية عراقية مع تضمين 768 بعداً (Gemini text-embedding-004)';
