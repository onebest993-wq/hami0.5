...
**والأربع المتذبذبة:** تسقط في المحاولة الأولى عند انتظار تبويب «عاجل» خمسَ ثوانٍ،
وتمرّ في الإعادة — أي **سباقٌ مع تحميل الجسم الكسول**، لا أثرٌ للغطاء. ولا يُدّعى أنّ
التعديل سبّبه ولا أنّه لم يسبّبه: قبل التعديل كانت هذه الأربع تسقط بالغطاء، فلا خطّ
أساس لتذبذبها.
